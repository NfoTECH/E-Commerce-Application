			...
			<div class="container">
				<div class="signup-content">
						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<label for="name"><i
									...
									type="text" name="name" id="name" placeholder="Full Name" required = "required"/>
							</div>
							<div class="form-group">
					...
					<div class="signup-image">
						<figure>
							<img src="images/SignInImage.jpeg" alt="sign up image">
						</figure>
						<a href="login.jsp" class="signup-image-link">Existing User? Sign In</a>
					</div>
				</div>
			</div>
		</section>
